  ...
  void GUIWidget::Render() {
    ...
    if (m_drawBorders) {
      ...
      auto borderLeftalArea
          = RectF{ finalArea.x - horizontalBorderWidth, finalArea.y, horizontalBorderWidth, finalArea.h };
      ...
      auto borderCornerTopRightArea = RectF{ finalArea.x + finalArea.w, finalArea.y - verticalBorderWidth,
                                             horizontalBorderWidth, verticalBorderWidth };
      ...
      auto borderCornerBottomLeftArea = RectF{ finalArea.x - horizontalBorderWidth, finalArea.y + finalArea.h,
                                               horizontalBorderWidth, verticalBorderWidth };
