...
namespace JourneyOfDreams
{
  LoginScene::LoginScene() {
    ...
    loginPanel->AddWidget(
        std::make_shared<GUILabel>(PointF{0.0f, 0.0f}, "Login"));
    loginPanel->AddWidget(std::make_shared<GUIButton>(
    ...
    loginPanel->AddWidget("UsernameTextBox", std::make_shared<GUITextBox>(RectF{
                                                 0.05f, 0.05f, 0.18f, 0.05f}));
    loginPanel->AddWidget(
        "PasswordTextBox",
