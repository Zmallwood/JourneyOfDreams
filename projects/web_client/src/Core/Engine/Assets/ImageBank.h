...
namespace JourneyOfDreams
{
   ...
   class ImageBank {
    public:
      ...
      /////////////////////////////////////////////////
      GLuint
      GetImage(const std::string &imageName);
      /////////////////////////////////////////////////
      ...
      /////////////////////////////////////////////////
      GLuint
      CreateBlankImage(const std::string &uniqueImageName);
    private:
      void
      LoadImages();
      GLuint
      LoadSingleImage(const std::string &absFilePath);
      SDL_Surface *
