...
namespace journey_of_dreams
{
  ...
  GLuint
  ImageBank::CreateBlankImage(const std::string &uniqueImageName) {
  ...
  GLuint
  ImageBank::LoadSingleImage(const std::string &absFilePath) {
