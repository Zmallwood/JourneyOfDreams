...
namespace zw
{
    GUITextBox::GUITextBox(zw::Engine& engine, RectF area, ColorF textColor, bool passwordMode)
        : GUIWidget(engine, area), m_textColor(textColor), m_cursorHeight(area.h - 2 * Padding()),
