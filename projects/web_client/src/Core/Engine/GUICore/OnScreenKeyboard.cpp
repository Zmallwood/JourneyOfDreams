...
namespace JourneyOfDreams
{
    ...
    void OnScreenKeyboard::Initialize()
    {
        ...
        AddWidget("btn2", std::make_shared<GUIButton>(RectF{ 0.018f, 0.0f, 0.015f, 0.05f }, "2",
                                                      [this]() { TypeCharacter('2'); }));
        AddWidget("btn3", std::make_shared<GUIButton>(RectF{ 0.036f, 0.0f, 0.015f, 0.05f }, "3",
                                                      [this]() { TypeCharacter('3'); }));
        AddWidget("btn4", std::make_shared<GUIButton>(RectF{ 0.054f, 0.0f, 0.015f, 0.05f }, "4",
                                                      [this]() { TypeCharacter('4'); }));
        AddWidget("btn5", std::make_shared<GUIButton>(RectF{ 0.072f, 0.0f, 0.015f, 0.05f }, "5",
                                                      [this]() { TypeCharacter('5'); }));
        AddWidget("btn6", std::make_shared<GUIButton>(RectF{ 0.09f, 0.0f, 0.015f, 0.05f }, "6",
                                                      [this]() { TypeCharacter('6'); }));
        AddWidget("btn7", std::make_shared<GUIButton>(RectF{ 0.108f, 0.0f, 0.015f, 0.05f }, "7",
                                                      [this]() { TypeCharacter('7'); }));
        AddWidget("btn8", std::make_shared<GUIButton>(RectF{ 0.126f, 0.0f, 0.015f, 0.05f }, "8",
                                                      [this]() { TypeCharacter('8'); }));
        AddWidget("btn9", std::make_shared<GUIButton>(RectF{ 0.144f, 0.0f, 0.015f, 0.05f }, "9",
