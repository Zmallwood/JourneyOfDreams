...
namespace JourneyOfDreams
{
  ...
  GUI::Update() {
    ...
    ** Focus next widget on pressing the tab key. */
    ...
    /*
    ** Clear all typed text input as it has already been handled by the GUIs
    *widgets. */
  ...
  void
  GUI::SetFocusedWidget(std::shared_ptr<GUIWidget> focusedWidget) {
    /*
    ** Setter */
