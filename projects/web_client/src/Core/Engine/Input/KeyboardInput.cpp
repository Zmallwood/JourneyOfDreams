...
namespace journey_of_dreams
{
  ...
  void
  KeyboardInput::OnKeyRelease(int key) {
    /*
  ...
  bool
  KeyboardInput::KeyIsPressed(int key) {
    /*
  ...
  bool
  KeyboardInput::KeyHasBeenFiredPickResult(int key) {
    /*
    ** Pick out result. */
  ...
  void
  KeyboardInput::AppendTextInput(const std::string &text) {
    /*
